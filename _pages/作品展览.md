...
<body>
    ...
    <main class="cleaner-report">
        <!-- 预览区域 -->
        <section class="report-preview">
            <iframe src="/assets/AI Infra研究报告.pdf" width="50%" height="600px" style="border: none;"></iframe>
        </section>
    </main>
</body>
...
<body>
    ...
    <main class="cleaner-report">
        <!-- 预览区域 -->
        <section class="report-preview">
            <iframe src="/assets/AI电力研究报告.pdf" width="50%" height="600px" style="border: none;"></iframe>
        </section>
    </main>
</body>
