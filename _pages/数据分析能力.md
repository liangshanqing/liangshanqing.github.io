...
<head>
    ...
    <title>数据分析能力</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.8.0/styles/dracula.min.css"> <!-- 引入深色主题样式 -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.8.0/highlight.min.js"></script> <!-- 引入highlight.js库 -->
    <style>
        pre {
            overflow-x: auto;
            overflow-y: auto;
